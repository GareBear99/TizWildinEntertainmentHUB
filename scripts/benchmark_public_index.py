...
out={'schemaVersion':'2.0','generatedAt':time.strftime('%Y-%m-%dT%H:%M:%SZ', time.gmtime()),'results':results,'totalSeconds':total,'grade':grade,'recommendation':'Keep public-index, branch validation, and source-index as separate CI jobs once the graph passes 25 repositories.'}
